...
class YYLyricsLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final phone = phoneLayout ?? mediaWidth < 600;
    ...
    Widget surface(BuildContext context, YYControlInteraction interaction) {
                    ...
                    if (translation != null && translation!.isNotEmpty) ...[
                      ...
                      Text(
                        ...
                        style: YYTypography.text(
                          ...
                          weight: 570,
                          height: 1.35,
                          color: lineColor.withValues(alpha: lineColor.a * .58),
                        ),
                      ),
                    ],
                  ],
